    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mt-12 rounded-2xl border border-amber-500/40 bg-gradient-to-br from-amber-500/10 to-orange-500/5 p-8">
          ...
          <a
            href="https://buy.stripe.com/8x24gz7gd8NA6BG20k9fW02&body=Hi%20Alex%2C%20I%20want%20PromptVault%20Pro.%20Sending%20%C2%A325%20via%20PayPal%20to%20alex.promptvault%40gmail.com.%20Send%20me%20the%20pack."
